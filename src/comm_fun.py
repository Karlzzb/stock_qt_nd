...
class Config:
    ...
    STABLE_FEATURES = [
        ...
        'close_vs_high_z', 'sh_amplitude', 'volatility_30d_z', 'close_vs_high', 'volatility_25d',
        'volatility_20d', 'obv', 'return_lag_20', 'dist_to_high_60', 'volatility_25d_z',
        'price_volume_divergence_rankpct', 'sh_sz_sync_strength', 'pv_corr_10', 'pv_corr_10_z', 'sz_amplitude',
        'volatility_20d_z', 'ret_intraday_z', 'dist_to_high_60_z', 'volume_consistency_z', 'volume_consistency',
        'market_sync_score', 'support_resistance_ratio', 'intraday_pos', 'clv', 'volatility_15d', 'intraday_pos_z',
        'clv_z', 'volatility_15d_z', 'cs_n', 'price_volume_divergence', 'volume_dryup_z', 'volume_dryup',
        'vol_gk_lag_3', 'smart_money_diff', 'log_volume', 'support_resistance_ratio_z', 'volatility_10d',
        'upper_shadow_ratio_z', 'ret_intraday_lag_1_z', 'ma_20', 'efficiency_ratio_lag_1', 'macd_hist_amplitude',
        'price_volume_divergence_z', 'vol_gk_lag_3_z', 'volatility_10d_z', 'intraday_pos_lag_3', 'efficiency_ratio_z',
        'atr_ratio_rankpct', 'ret_intraday', 'ret_overnight_lag_1', 'sh_volume_ratio', 'price_vs_ma5',
        'vol_gk_ratio_lag_3', 'vol_gk_ratio_lag_3_z', 'sz_price_change', 'return_lag_1', 'pv_corr_10_rankpct',
        'efficiency_ratio_lag_1_z', 'efficiency_ratio_lag_3', 'vol_gk_lag_1', 'body_strength_z', 'low_lag_30_rankpct',
        'intraday_pos_lag_3_z', 'market_sentiment', 'price_vs_ma5_z', 'return_lag_20_z', 'bb_squeeze_rankpct',
        'intraday_pos_lag_2', 'vol_divergence_z', 'hammer_pattern_rankpct', 'market_avg_amplitude_rankpct',
        'sz_volume_signal_rankpct', 'market_sync_score_rankpct', 'sh_sz_sync_direction_rankpct',
        'market_sentiment_rankpct', 'sz_sentiment_rankpct', 'sh_sz_sync_strength_rankpct', 'rsi_oversold_24_rankpct',
        'sz_price_change_rankpct', 'rsi_oversold_14_rankpct', 'sh_amplitude_rankpct', 'market_avg_change_rankpct',
        'sh_sentiment_rankpct', 'sz_volume_ratio_rankpct', 'sz_amplitude_rankpct', 'doji_pattern_rankpct',
        'sh_price_change_rankpct', 'sh_volume_signal_rankpct', 'sh_volume_ratio_rankpct',
        'support_resistance_ratio_lag_5_rankpct', 'efficiency_ratio_lag_3_z', 'close_d0.4', 'efficiency_ratio_lag_5_z',
        'upper_shadow_ratio_rankpct', 'upper_shadow_ratio', 'sh_sentiment', 'vol_divergence', 'efficiency_ratio_lag_5',
        'ma_60', 'return_lag_3', 'vol_gk_z', 'intraday_pos_lag_1', 'close_d0.4_z', 'vol_gk_ratio_z',
        'body_strength_rankpct',
    ]
