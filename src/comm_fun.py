...
class Config:
    ...
    STRATEGY_PARAMS_CANDIDATES_V8 = {
     "参数1":   {  # 测试&验证集表现： 回报率:8.407488822937012 倍  |  最大回撤： -0.256617784500122 | 胜率：0.5333333333333333 | 总交易数：165.0 | sharpe_ratio：1.69266180163751
     ...
     "参数2":   {  # 测试&验证集表现： 回报率:8.147415161132812 倍  |  最大回撤： -0.2562417387962341 | 胜率：0.5481927710843374 | 总交易数：166.0 | sharpe_ratio：1.6919786561088015
     ...
     "参数3":   {  # 测试&验证集表现： 回报率:7.1439528465271 倍  |  最大回撤： -0.2412424832582473 | 胜率：0.5333333333333333 | 总交易数：165.0 | sharpe_ratio：1.7102585419478633
     ...
     "参数4":   {  # 测试&验证集表现： 回报率:6.989335060119629 倍  |  最大回撤： -0.24082712829113 | 胜率：0.5481927710843374 | 总交易数：166.0 | sharpe_ratio：1.709129036976445
     ...
     "参数5":   {  # 测试&验证集表现： 回报率:6.732370853424072 倍  |  最大回撤： -0.2554791569709778 | 胜率：0.5056179775280899 | 总交易数：178.0 | sharpe_ratio：1.5719606244180258
     ...
     "参数6":   {  # 测试&验证集表现： 回报率:6.551973342895508 倍  |  最大回撤： -0.2945987284183502 | 胜率：0.5277777777777778 | 总交易数：216.0 | sharpe_ratio：1.742972954710985
     ...
     "参数7":   {  # 测试&验证集表现： 回报率:5.684689521789551 倍  |  最大回撤： -0.2405117303133011 | 胜率：0.5056179775280899 | 总交易数：178.0 | sharpe_ratio：1.572534447813497
     ...
     "参数8":   {  # 测试&验证集表现： 回报率:5.618587493896484 倍  |  最大回撤： -0.2913717031478882 | 胜率：0.5277777777777778 | 总交易数：216.0 | sharpe_ratio：1.705361428716547
     ...
     "参数9":   {  # 测试&验证集表现： 回报率:5.536756038665772 倍  |  最大回撤： -0.2570503354072571 | 胜率：0.5304878048780488 | 总交易数：164.0 | sharpe_ratio：1.4375484725830396
     ...
     "参数10":   {  # 测试&验证集表现： 回报率:5.059552192687988 倍  |  最大回撤： -0.275324285030365 | 胜率：0.5034013605442177 | 总交易数：147.0 | sharpe_ratio：1.6696473721187128
     ...
     "参数11":   {  # 测试&验证集表现： 回报率:4.992498874664307 倍  |  最大回撤： -0.2945987284183502 | 胜率：0.5142857142857142 | 总交易数：210.0 | sharpe_ratio：1.5839634407017005
     ...
     "参数12":   {  # 测试&验证集表现： 回报率:4.955350399017334 倍  |  最大回撤： -0.2559797465801239 | 胜率：0.5529411764705883 | 总交易数：170.0 | sharpe_ratio：1.688479405413035
     ...
     "参数13":   {  # 测试&验证集表现： 回报率:4.721324920654297 倍  |  最大回撤： -0.2945987284183502 | 胜率：0.5412844036697247 | 总交易数：218.0 | sharpe_ratio：1.5395479077575118
     ...
     "参数14":   {  # 测试&验证集表现： 回报率:4.541333198547363 倍  |  最大回撤： -0.2416596859693527 | 胜率：0.5304878048780488 | 总交易数：164.0 | sharpe_ratio：1.4254372765983112
     ...
     "参数15":   {  # 测试&验证集表现： 回报率:4.51566219329834 倍  |  最大回撤： -0.2405167669057846 | 胜率：0.5529411764705883 | 总交易数：170.0 | sharpe_ratio：1.6826908691405504
     ...
     "参数16":   {  # 测试&验证集表现： 回报率:4.396641254425049 倍  |  最大回撤： -0.258291482925415 | 胜率：0.5034013605442177 | 总交易数：147.0 | sharpe_ratio：1.622872342400167
     ...
     "参数17":   {  # 测试&验证集表现： 回报率:4.239380359649658 倍  |  最大回撤： -0.2916379570960998 | 胜率：0.5142857142857142 | 总交易数：210.0 | sharpe_ratio：1.5482562167371932
     ...
     "参数18":   {  # 测试&验证集表现： 回报率:4.204626083374023 倍  |  最大回撤： -0.275324285030365 | 胜率：0.5163398692810458 | 总交易数：153.0 | sharpe_ratio：1.575598294840682
     ...
     "参数19":   {  # 测试&验证集表现： 回报率:4.071984767913818 倍  |  最大回撤： -0.2903741002082824 | 胜率：0.5349794238683128 | 总交易数：243.0 | sharpe_ratio：1.5484673215462026
     ...
     "参数20":   {  # 测试&验证集表现： 回报率:4.031685829162598 倍  |  最大回撤： -0.2910231947898865 | 胜率：0.5412844036697247 | 总交易数：218.0 | sharpe_ratio：1.493501260312462
     ...
     "参数21":   {  # 测试&验证集表现： 回报率:4.031220436096191 倍  |  最大回撤： -0.2544674873352051 | 胜率：0.5055555555555555 | 总交易数：180.0 | sharpe_ratio：1.536547439294639
