...
class Config:
    ...
    STRATEGY_PARAMS_CANDIDATES_V12 = {
        "param1": {  # v8_param29 | 回报率:4.4417 | 最大回撤:-0.2784 | 胜率:0.5794 | 夏普:2.1071 | 交易数:126
            "base_ratio": 1.0,
            "target_profit": 0.3,
            "hard_stop_loss": -0.14,
            "max_hold_days": 15,
        ...
        "param2": {  # v8_param35 | 回报率:4.3847 | 最大回撤:-0.2860 | 胜率:0.5827 | 夏普:2.0786 | 交易数:127
            "base_ratio": 1.0,
            "target_profit": 0.25,
            "hard_stop_loss": -0.14,
            "max_hold_days": 16,
        ...
        "param3": {  # v8_param20 | 回报率:4.2811 | 最大回撤:-0.2783 | 胜率:0.5794 | 夏普:2.0538 | 交易数:126
            "base_ratio": 1.0,
            "target_profit": 0.35,
            "hard_stop_loss": -0.14,
            "max_hold_days": 15,
        ...
        "param4": {  # v8_param21 | 回报率:4.1445 | 最大回撤:-0.2761 | 胜率:0.6068 | 夏普:1.9199 | 交易数:117
            "base_ratio": 1.0,
            "target_profit": 0.3,
            "hard_stop_loss": -0.14,
            "max_hold_days": 19,
        ...
        "param5": {  # v8_param42 | 回报率:4.0769 | 最大回撤:-0.2776 | 胜率:0.5781 | 夏普:2.0309 | 交易数:128
            "base_ratio": 1.0,
            "target_profit": 0.25,
            "hard_stop_loss": -0.14,
            "max_hold_days": 15,
        ...
        "param6": {  # v8_param31 | 回报率:4.0114 | 最大回撤:-0.2851 | 胜率:0.5726 | 夏普:1.9383 | 交易数:124
            "base_ratio": 1.0,
            "target_profit": 0.3,
            "hard_stop_loss": -0.14,
            "max_hold_days": 16,
        ...
        "param7": {  # v8_param24 | 回报率:3.8619 | 最大回撤:-0.2763 | 胜率:0.6068 | 夏普:1.8143 | 交易数:117
            "base_ratio": 1.0,
            "target_profit": 0.35,
            "hard_stop_loss": -0.14,
            "max_hold_days": 19,
        ...
        "param8": {  # v8_param26 | 回报率:3.7278 | 最大回撤:-0.2920 | 胜率:0.5726 | 夏普:1.8478 | 交易数:124
            "base_ratio": 1.0,
            "target_profit": 0.35,
            "hard_stop_loss": -0.14,
            "max_hold_days": 16,
        ...
        "param9": {  # v8_param1 | 回报率:3.5363 | 最大回撤:-0.2765 | 胜率:0.5952 | 夏普:1.8080 | 交易数:126
            "base_ratio": 1.0,
            "target_profit": 0.2,
            "hard_stop_loss": -0.14,
            "max_hold_days": 19,
        ...
        "param10": {  # v8_param5 | 回报率:3.0348 | 最大回撤:-0.2825 | 胜率:0.6050 | 夏普:1.5713 | 交易数:119
            "base_ratio": 1.0,
            "target_profit": 0.35,
            "hard_stop_loss": -0.14,
            "max_hold_days": 18,
    ...
    STRATEGY_PARAMS_V12 = STRATEGY_PARAMS_CANDIDATES_V12["param1"]
