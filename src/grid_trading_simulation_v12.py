...
def simple_run(initial_capital, strategy_name, strategy_params, full_data, prices_df=None, atr_cache=None,
               st_preloaded=None):
    ...
    # 【重要】开启了 show_progress=True，单进程跑单参数时恢复进度条显示
    ...
    if not trade_log.empty:
        ...
        if len(closed_trades) > 0:
            ...
            result['lose_count'] = len(closed_trades) - win_count
