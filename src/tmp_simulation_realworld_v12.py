...
# 加载所有股票的行情数据
from grid_trading_simulation_v12 import load_price_data

full_data_dict = load_price_data(str(STOCK_DATA_DIR))
from grid_trading_simulation_v12 import convert_dict_to_dataframe_from_index
...
# 找到起始日期范围内的交易日（注意：需要确保数据范围与grid_trading_simulation_v12.py一致，start_date="20251001"）
start_date_str = "20251001"
end_date_str = "20260407"
